...
public class PassengerMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private FirebaseUser currentPassenger;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentPassenger = auth.getCurrentUser();
        ...
        bookTaxiButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              gettingNearestTaxi();
               // Log.d("mylog", "nearestDriverId = " + nearestDriverId);
        ...
        nearestDriverLocation.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    bookTaxiButton.setText("driver is in "+ (int)distanceToDriver + " m");
    ...
    private void gettingNearestTaxi() {
        ...
        geoQuery.addGeoQueryEventListener(new GeoQueryEventListener() {
            ...
            public void onKeyEntered(String key, GeoLocation location) {
                if (!isDriverFound) {
                    isDriverFound = true;
                  nearestDriverId = key;
                    bookTaxiButton.setText(nearestDriverId);
                    getNearestDriverLocation();
            ...
            public void onGeoQueryReady() {
                ...
                if (!isDriverFound && searchRadius < 100) {
                    searchRadius++;
                    gettingNearestTaxi();
                }
       ...
       // Log.d("mylog", "gettingNearestTaxiId = " + driverId[0]);

    }

    private void signOutPassenger() {

        String passengerUserId = currentPassenger.getUid();
