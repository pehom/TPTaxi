...
public class PassengerSignInActivity extends AppCompatActivity {
                        ...
                        .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                   ...
                                   // createUser(user);
                                    Toast.makeText(PassengerSignInActivity.this, "Successful  reg", Toast.LENGTH_LONG).show();
    ...
    private void createUser(FirebaseUser user) {
        ...
        passenger.setId(user.getUid());
        passenger.setName(nameTextInput.getEditText().getText().toString().trim());
        passengersDatabaseReference.child(user.getUid()).setValue(passenger);
